...
/**
 * Event fired when the main Claude agent stops. Observation-only — hooks can
 ...
 */
public record AgentStop(String sessionId, boolean stopHookActive, HookContext context) implements HookEvent {
}
